/*
 * ѕоліцейська картотека
 * дані про злочинця: ѕ.≤.Ѕ.; дата народження; дати судимостей (кількість не обмежена); 
 * дата останнього позбавлення волі; дата останнього звільнення.
*/
...
public class PoliceCabinet {
	...
	public  Date DatesOfConvictions[]; /// дати судимостей
